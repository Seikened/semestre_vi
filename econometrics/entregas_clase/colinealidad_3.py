...
y = np.array([1_500_000, 2_500_000, 2_750_000, 3_200_000, 3_500_000, 4_000_000])

# Variables Independientes (X)
# Extraídas de la imagen
tamano_x1       = np.array([80, 100, 120, 150, 180, 200])
habitaciones_x2 = np.array([2, 3, 3, 4, 4, 5])
banos_x3        = np.array([1, 2, 2, 3, 3, 4])

# Creamos la matriz X uniendo las 3 columnas
X = np.column_stack((tamano_x1, habitaciones_x2, banos_x3))
...
colinealidad(X, ["Tamaño", "Habitaciones", "Baños"])

log.note("Respuesta:")
log.metric("Todas aun que Habitacion y baño dan inf")
log.metric("Si, hay multicolinealidad ya que ambas variables están altamente correlacionadas.")
