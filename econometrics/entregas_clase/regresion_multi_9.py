...
precio_y = np.array([800, 950, 1100, 1300, 1550, 2800, 3500, 4800, 6200, 8000])

# Variable Independiente (X): Tamaño (m²)
tamano_x = np.array([50, 60, 70, 80, 90, 150, 180, 220, 260, 300])

# Preparación de matrices para scikit-learn / statsmodels
X = np.column_stack((tamano_x,))
y = precio_y
...
Grafica residuos vs valores ajustados (Ŷ).
